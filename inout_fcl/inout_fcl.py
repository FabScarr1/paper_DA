...
for rs in random_states:
    ...
    #'/fs_part1/phd/mo31/gen_data/domAmazon
    data_dir = opt.data_path_dom1+'/N'+rs+'/'
    #'/fs_part1/phd/mo31/gen_data/domSynthetic
    ...
    t_centr = torch.load(data_dir+'t_centr_N'+rs+'.pt')
    ...
    print('t_centr.shape {}'.format(t_centr.shape))
    ...
    if cnf.perc_exp != 0.0:
        ...
        for i in range(opt.num_classes):
            ...
            v_plus= v+v*opt.io_perc #vec from centroidds
            cl_p_away = c + v_plus 
    ...
    class Multiclass(nn.Module):
        def __init__(self):
            ...
            self.output = nn.Linear(4096,opt.num_classes)
